...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    current: true,
    accentColor: "#2a9d8f",
story: `Finbox is a high-growth digital lending fintech, and I partner with leadership across a 230+ employee span inside a 370-person organization, leading initiatives across performance management, OKR governance, career architecture, manager effectiveness, and employee feedback systems.

I also designed and built the Finbox People app, a structured people-intelligence layer that captures connect and feedback data and translates it into dashboards and actionable insights, intended to give leadership organization-wide visibility into engagement trends, recurring pain points, and emerging attrition risks.`,    
    description:
