...
const defaultSections: SectionData[] = [
  {
    ...
    img: "https://images.unsplash.com/photo-1576277279377-8628d830df5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MDA2OTF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NjM0ODE4NjJ8&ixlib=rb-4.1.0&q=80&w=1080" // Photo by Voice + Video on Unsplash
  },
  {
    text: "Ethereal Moments",
    img: "https://images.unsplash.com/photo-1678347123725-2d0d31bc06bd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MDA2OTF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NjM0ODE4NjJ8&ixlib=rb-4.1.0&q=80&w=1080" // Photo by Deng Xiang on Unsplash
  },
  {
    text: "Silent Beauty",
    img: "https://images.unsplash.com/photo-1704030459079-c31da57b848d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MDA2OTF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NjM0ODE4NjJ8&ixlib=rb-4.1.0&q=80&w=1080" // Photo by Mockup Free on Unsplash
  }
];
...
useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className={`h-screen w-screen overflow-hidden bg-black text-white uppercase ${className}`}
    >
